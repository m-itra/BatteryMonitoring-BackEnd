...
2. заполненный файл Infrastructure/.env
...
Все сервисы читают настройки из Infrastructure/.env.  
...
Локальный запуск и миграции описаны в README соответствующих сервисов и в Infrastructure/README.md.
